 ...
 *
 * <p>There is nothing special about this class that enforces the longevity of the Avm instance.
 * However, this is the singleton access-point that any thread using the Avm will come through.
 *
 * <p>This instance should be created once, by a single thread, before any other thread can possibly
 * access this class.
 *
 * <p>This instance should be shutdown using {@code destroy()} by only a single thread, once any
 * other threads are no longer using this class.
 */
public final class LongLivedAvm {
     ...
     *
     * <p>This method is not thread-safe. Only a single thread should ever call this method, and it

...
public class AionContractDetailsTest {
    ...
    public void test_22() throws Exception {
        ...
        contractDetails.setAddress(address);
        contractDetails.put(new DataWord(key_0), new DataWord(val_0));
        contractDetails.put(new DataWord(key_1), new DoubleDataWord(val_1));
        contractDetails.put(new DataWord(key_2), new DoubleDataWord(val_2));
        contractDetails.put(new DataWord(key_3), new DoubleDataWord(val_3));
        contractDetails.put(new DataWord(key_4), new DoubleDataWord(val_4));
        contractDetails.put(new DoubleDataWord(key_5), new DoubleDataWord(val_5));
        contractDetails.put(new DoubleDataWord(key_6), new DoubleDataWord(val_6));
        contractDetails.put(new DoubleDataWord(key_7), new DoubleDataWord(val_7));
        contractDetails.put(new DoubleDataWord(key_8), new DoubleDataWord(val_8));
        contractDetails.put(new DoubleDataWord(key_9), new DoubleDataWord(val_9));
        contractDetails.put(new DataWord(key_10), new DataWord(val_10));
        contractDetails.put(new DataWord(key_11), new DataWord(val_11));
        contractDetails.put(new DataWord(key_12), new DataWord(val_12));
        contractDetails.put(new DataWord(key_13), new DataWord(val_13));

...
public class UnityTotalDifficultyTest {
    ...
    public void testImportPOWMultiPOS() {
        ...
        result = bc.tryToConnectForTest(blockThreePOS, (long) (blockTwoPOS.getTimestamp() + delta));
    ...
    public void testHigherDifficultyPOSFork() {
        ...
        assertThat(bc.tryToConnectForTest(blockThreePOS, (long) (blockTwoPOS.getTimestamp() + delta))).isEqualTo(ImportResult.IMPORTED_BEST);
    }
    ...
    public void testSamePOSPOWDifficulty() {
        ...
        GenesisStakingBlock genesisStakingBlock = spy(new GenesisStakingBlock(new byte[32]));

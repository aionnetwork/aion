...
public class BlockchainEnergyTest {
    ...
    public void testConsistentEnergyUsage() {
        ...
        AionBlock block = (AionBlock) bc.createNewMiningBlock(bc.getBestBlock(), Collections.EMPTY_LIST, true);
    ...
    public void testEnergyUsageRecorded() {
        ...
        AionBlock block = (AionBlock) bc.createNewMiningBlock(bc.getBestBlock(), txs, true);
        ...
        AionBlock secondBlock = (AionBlock) bc.createNewMiningBlock(bc.getBestBlock(), Collections.EMPTY_LIST, true);

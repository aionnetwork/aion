...
public class GenesisSpecificationTest {
    ...
    /**
     * Test that the default genesis block built from the builder produces the correct genesis
     * specs
     */
    @Test
    ...
    public void overrideGenesisBlockTest() throws HeaderStructureException {
        ...
        byte[] overrideHash = ByteUtil
            .hexStringToBytes("DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF");
        byte[] overrideAddress = ByteUtil
            .hexStringToBytes("DEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEFDEADBEEF");

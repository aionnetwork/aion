...
public class BlockchainEnergyTest {
    ...
    public void testEnergyUsageRecorded() {
        ...
        MiningBlock block = bc.createNewMiningBlock(bc.getBestBlock(), txs, true);
        ...
        MiningBlock secondBlock = bc.createNewMiningBlock(bc.getBestBlock(), Collections.EMPTY_LIST, true);

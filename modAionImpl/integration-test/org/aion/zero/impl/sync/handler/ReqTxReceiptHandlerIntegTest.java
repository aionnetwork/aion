...
public class ReqTxReceiptHandlerIntegTest {
     ...
     *
     * Information about this block from Web3:
     * <tt>{
     *   blockHash: '0xafdaf9af7033a6b08c891e2df04469cd3feb571b010134d2556fcd2bd5de1b7e',
     *   nrg: 22000,
     *   transactionIndex: 0,
     *   nonce: 1,
     *   input: '0x00',
     *   blockNumber: 213091,
     *   gas: 22000,
     *   from: '0xA0112D226E668107793692a54e2524850431a1a2F3005626c588deBf75EE48Fa',
     *   to: '0xA045546D448E2130F7eC9F1E8F5452d3a133DA2484F28C4f108B1a4DF2ae4e4A',
     *   value: '7000000000000000000',
     *   hash: '0xfd9d619166e1e0c8f60c6fd6bacb8e2629d5429db9d435034c79b1cd1d41c700',
     *   gasPrice: '10000000000'
     * }</tt>

     * </tt>
     */
    private byte[] TEST_TX = ByteUtils.fromHexString("fd9d619166e1e0c8f60c6fd6bacb8e2629d5429db9d435034c79b1cd1d41c700");

    /**
     * This test requires a running kernel to work, as it will send it a receipt request and verify the response.
     * The kernel needs to be set up in the following way in order for the test to work (or you can modify the
     * test to match your kernel):
     *   - must be on mastery (have net id 32) and synced up to at least block 213091
     *   - must run on local host on port 35303
     *   - use id 33de4394-9e65-40b1-b241-701d82fa782c
     */
    @Test
    public void test() throws Exception {
        ...
        assertThat(ByteUtil.toHexString(capturedTxs.get(0).getBlockHash()), is("afdaf9af7033a6b08c891e2df04469cd3feb571b010134d2556fcd2bd5de1b7e"));
    ...
    public static AionBlock createDummyBlock() {
        ...
        return new AionBlock(parentHash, AionAddress.wrap(coinbase), logsBloom, difficulty, number, timestamp, extraData, nonce,

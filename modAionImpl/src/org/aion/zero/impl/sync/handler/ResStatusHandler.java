...
public final class ResStatusHandler extends Handler {
    ...
    public void receive(int _nodeIdHashcode, String _displayId, final byte[] _msgBytes) {
        ...
        if (rs == null) {
            this.log
                .error("<res-status decode-error from {} len: {}>", _displayId, _msgBytes.length);
        ...
        if (node != null && rs != null) {
            if (log.isDebugEnabled()) {
                this.log
                    .debug("<res-status node={} best-blk={}>", _displayId, rs.getBestBlockNumber());
            }
            ...
            if (remoteTdBytes != null && remoteBestBlockHash != null) {
                ...
                node.updateStatus(remoteBestBlockNumber, remoteBestBlockHash,
                    remoteTotalDifficulty);
                syncMgr.updateNetworkStatus(_displayId, remoteBestBlockNumber, remoteBestBlockHash,
                    remoteTotalDifficulty);
            }
        }
    }

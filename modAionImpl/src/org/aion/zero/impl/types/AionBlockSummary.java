...
public class AionBlockSummary extends
    AbstractBlockSummary<IAionBlock, AionTransaction, AionTxReceipt, AionTxExecSummary> implements
    IBlockSummary {

    public AionBlockSummary(IAionBlock block, Map<Address, BigInteger> rewards,

...
public class MiningBlock extends AbstractBlock {
    ...
    public MiningBlock(MiningBlock block) {
        ...
        this.header = MiningBlockHeader.Builder.newInstance().withHeader(block.getHeader()).build();
     ...
     * header that is equal to the header generated by {@link MiningBlockHeader.Builder#build()} .
     *
    ...
    public MiningBlockHeader getHeader() {
        return this.header;
    }
    ...
    public void updateHeader(BlockHeader _header) {
        ...
        header = (MiningBlockHeader) _header;
    }
     ...
     * states:
     *
     * <p>{@link MiningBlockHeader#txTrieRoot} {@link MiningBlockHeader#receiptTrieRoot} {@link
     * MiningBlockHeader#stateRoot} {@link MiningBlockHeader#logsBloom} {@link
     * this#transactionsList} {@link MiningBlockHeader#energyConsumed}
     *
     * <p>The (as of now) unenforced contract by using this function is that the user should not
     * modify any fields set except for {@link MiningBlockHeader#solution} and {@link
     * MiningBlockHeader#nonce} after this function is called.
     *

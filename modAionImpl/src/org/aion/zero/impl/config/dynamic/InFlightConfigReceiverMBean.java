 ...
 *
 * (Not using "I" prefix convention here because need to follow interface-naming convention for
 * MBean).
 */
public interface InFlightConfigReceiverMBean {
     ...
     * kernel; an operation which will either entirely succeed or fail (no partial results; if part
     * of the config is applied and then a later part fails, all changes are undone).
     *

 ...
 * new Cfgs.
 *
 * Any change that is performed by {@link #apply(Cfg, Cfg)} must be revertible by calling {@link
...
public interface IDynamicConfigApplier {
    ...
    /**
     * Undo changes to the Aion kernel that were successfully performed by {@link #apply(Cfg,
     * Cfg)}.
     *
     * @param oldCfg old config
     * @param newCfg new config

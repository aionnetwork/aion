...
public final class SliceInput
     ...
     * Transfers this buffer's data to the specified destination starting at the current {@code
     * position} and increases the {@code position} by the number of the transferred bytes (= {@code
     * length}).  This method is basically same with {@link #readBytes(Slice, int, int)}, except
     * that this method increases the {@code writerIndex} of the destination by the number of the

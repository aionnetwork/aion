...
public class H2MVMapWithCache extends AbstractDatabaseWithCache {

    public H2MVMapWithCache(String name, String path, boolean enableCache, boolean enableCompression,
        ...
        database = new H2MVMap(name, path, enableCache, enableCompression);
    }
}

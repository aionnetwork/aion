...
public final class TxRecpt {
    ...
    public <TXR extends AbstractTxReceipt> TxRecpt(
        ...
        this.contractAddress =
                tx.isContractCreationTransaction()
                        ? toJsonHex(TransactionUtil.calculateContractAddress(tx).toString())
                        : null;
    ...
    public TxRecpt(
        ...
        this.contractAddress = tx.isContractCreationTransaction() ? toJsonHex(TransactionUtil.calculateContractAddress(tx).toString()) : null;

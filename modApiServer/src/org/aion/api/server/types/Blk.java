...
public class Blk {
    ...
    public static Object AionBlockToJson(AionBlock block, BigInteger totalDifficulty,
        boolean fullTransaction) {
        if (block == null) {
            return null;
        }
        ...
        for (int i = 0; i < txs.size(); i++) {
            ...
            if (fullTransaction) {
                ...
                jsonTx.put("contractAddress", (tx.getContractAddress() != null) ? TypeConverter

...
public class NrgOracle {
     ...
     *
     * If multiple consumers want nrgPrice simultaneously, all will be blocked until the
     * recommendation is built and cached. Future consumers read the cached value until cache
     * flush.
     */
    ...
    public NrgOracle(IAionBlockchain blockchain, long nrgPriceDefault, long nrgPriceMax,
        Strategy strategy) {
        ...
        switch (strategy) {
            case BLK_PRICE:
                this.advisor = new NrgBlockPrice(nrgPriceDefault, nrgPriceMax, BLKPRICE_WINDOW,
                    BLKPRICE_PERCENTILE);

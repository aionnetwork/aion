    ...
    public void objectTest() {
        for (int a = 0; a < size1; a++) {
            try {
                ...
                System.out.println(bytesToBigInteger(temp1));
            } catch (NullPointerException e) {
                System.out.println("\nNull Object Test!");
            }
        }
...
//                byte[] temp5 = intsToBytes(testInt[a], true);
//                byte[] temp6 = intsToBytes(testInt[a], temp5, true);
...
//                System.out.println(bytesToInts(temp5, true));
//                System.out.println(bytesToInts(temp6, testInt[a], true));
            }
        }
    }

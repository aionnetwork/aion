        ...
        assertEquals(
                ...
                sum(
                        ...
                        sum(
                                ...
                                sum(
                                        bigInt[2][0],
                                        sum(bigInt[3][0], sum(bigInt[4][0], bigInt[5][0]))))));
        ...
        assertEquals(
                ...
                sum(
                        ...
                        sum(
                                ...
                                sum(
                                        bigInt[2][1],
                                        sum(bigInt[3][1], sum(bigInt[4][1], bigInt[5][1]))))));
    }
        ...
        assertEquals(
                ...
                min(
                        ...
                        min(
                                ...
                                min(
                                        bigInt[2][0],
                                        min(bigInt[3][0], min(bigInt[4][0], bigInt[5][0]))))));
        ...
        assertEquals(
                ...
                max(
                        ...
                        max(
                                ...
                                max(
                                        bigInt[2][1],
                                        max(bigInt[3][1], max(bigInt[4][1], bigInt[5][1]))))));
    }
}

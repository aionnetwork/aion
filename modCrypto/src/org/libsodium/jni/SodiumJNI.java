...
public class SodiumJNI {
  ...
  public final static native int crypto_sign(byte[] signedMsg, int[] signedLen, byte[] msg, int msgLen, byte[] key);
  public final static native int crypto_sign_open(byte[] signedMsg, int[] signedLen, byte[] msg, int msgLen, byte[] key);

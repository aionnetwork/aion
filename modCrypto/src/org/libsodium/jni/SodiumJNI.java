...
public class SodiumJNI {
    ...
    public final static native int crypto_sign(byte[] signedMsg, int[] signedLen, byte[] msg,
        int msgLen, byte[] key);

    public final static native int crypto_sign_open(byte[] signedMsg, int[] signedLen, byte[] msg,
        int msgLen, byte[] key);
    ...
    public final static native int crypto_secretbox_easy(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);

    public final static native int crypto_secretbox_open_easy(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);

    public final static native int crypto_secretbox_detached(byte[] jarg1, byte[] jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_secretbox_open_detached(byte[] jarg1, byte[] jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, byte[] jarg6);
    ...
    public final static native int crypto_box_seed_keypair(byte[] jarg1, byte[] jarg2,
        byte[] jarg3);

    public final static native int crypto_box_easy(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_open_easy(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_detached(byte[] jarg1, byte[] jarg2, byte[] jarg3,
        int jarg4, byte[] jarg5, byte[] jarg6, byte[] jarg7);

    public final static native int crypto_box_open_detached(byte[] jarg1, byte[] jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, byte[] jarg6, byte[] jarg7);
    ...
    public final static native int crypto_box_easy_afternm(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);

    public final static native int crypto_box_open_easy_afternm(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, byte[] jarg5);

    public final static native int crypto_box_detached_afternm(byte[] jarg1, byte[] jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_open_detached_afternm(byte[] jarg1, byte[] jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_sealbytes();

    public final static native int crypto_box_seal(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);

    public final static native int crypto_box_seal_open(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);
    ...
    public final static native int crypto_box(byte[] jarg1, byte[] jarg2, int jarg3, byte[] jarg4,
        byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_open(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_afternm(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);

    public final static native int crypto_box_open_afternm(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);
    ...
    public final static native int crypto_sign_seed_keypair(byte[] jarg1, byte[] jarg2,
        byte[] jarg3);

    public final static native int crypto_sign_detached(byte[] jarg1, int[] jarg2, byte[] jarg3,
        int jarg4, byte[] jarg5);

    public final static native int crypto_sign_verify_detached(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4);
    ...
    public final static native int crypto_generichash(byte[] jarg1, int jarg2, byte[] jarg3,
        int jarg4, byte[] jarg5, int jarg6);

    public final static native int crypto_generichash_statebytes();

    public final static native int crypto_generichash_init(byte[] jarg1, byte[] jarg2, int jarg3,
        int jarg4);
    ...
    public final static native int crypto_shorthash(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);
    ...
    public final static native int crypto_auth_verify(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);
    ...
    public final static native int crypto_onetimeauth(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);

    public final static native int crypto_onetimeauth_verify(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);
    ...
    public final static native int crypto_aead_chacha20poly1305_encrypt(byte[] jarg1, int[] jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, int jarg6, byte[] jarg7, byte[] jarg8, byte[] jarg9);

    public final static native int crypto_aead_chacha20poly1305_decrypt(byte[] jarg1, int[] jarg2,
        byte[] jarg3, byte[] jarg4, int jarg5, byte[] jarg6, int jarg7, byte[] jarg8, byte[] jarg9);

    public final static native int crypto_aead_chacha20poly1305_ietf_npubbytes();

    public final static native int crypto_aead_chacha20poly1305_ietf_encrypt(byte[] jarg1,
        int[] jarg2, byte[] jarg3, int jarg4, byte[] jarg5, int jarg6, byte[] jarg7, byte[] jarg8,
        byte[] jarg9);

    public final static native int crypto_aead_chacha20poly1305_ietf_decrypt(byte[] jarg1,
        int[] jarg2, byte[] jarg3, byte[] jarg4, int jarg5, byte[] jarg6, int jarg7, byte[] jarg8,
        byte[] jarg9);
    ...
    public final static native int crypto_auth_hmacsha256(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);

    public final static native int crypto_auth_hmacsha256_verify(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4);

    public final static native int crypto_auth_hmacsha256_statebytes();

    public final static native int crypto_auth_hmacsha256_init(byte[] jarg1, byte[] jarg2,
        int jarg3);

    public final static native int crypto_auth_hmacsha256_update(byte[] jarg1, byte[] jarg2,
        int jarg3);
    ...
    public final static native int crypto_auth_hmacsha512(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);

    public final static native int crypto_auth_hmacsha512_verify(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4);

    public final static native int crypto_auth_hmacsha512_statebytes();

    public final static native int crypto_auth_hmacsha512_init(byte[] jarg1, byte[] jarg2,
        int jarg3);

    public final static native int crypto_auth_hmacsha512_update(byte[] jarg1, byte[] jarg2,
        int jarg3);
    ...
    public final static native int crypto_auth_hmacsha512256(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);

    public final static native int crypto_auth_hmacsha512256_verify(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4);

    public final static native int crypto_auth_hmacsha512256_statebytes();

    public final static native int crypto_auth_hmacsha512256_init(byte[] jarg1, byte[] jarg2,
        int jarg3);

    public final static native int crypto_auth_hmacsha512256_update(byte[] jarg1, byte[] jarg2,
        int jarg3);
    ...
    public final static native int crypto_box_curve25519xsalsa20poly1305(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_curve25519xsalsa20poly1305_open(byte[] jarg1,
        byte[] jarg2, int jarg3, byte[] jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_box_curve25519xsalsa20poly1305_seed_keypair(byte[] jarg1,
        byte[] jarg2, byte[] jarg3);

    public final static native int crypto_box_curve25519xsalsa20poly1305_keypair(byte[] jarg1,
        byte[] jarg2);

    public final static native int crypto_box_curve25519xsalsa20poly1305_beforenm(byte[] jarg1,
        byte[] jarg2, byte[] jarg3);

    public final static native int crypto_box_curve25519xsalsa20poly1305_afternm(byte[] jarg1,
        byte[] jarg2, int jarg3, byte[] jarg4, byte[] jarg5);

    public final static native int crypto_box_curve25519xsalsa20poly1305_open_afternm(byte[] jarg1,
        byte[] jarg2, int jarg3, byte[] jarg4, byte[] jarg5);
    ...
    public final static native int crypto_core_hsalsa20(byte[] jarg1, byte[] jarg2, byte[] jarg3,
        byte[] jarg4);
    ...
    public final static native int crypto_core_salsa20(byte[] jarg1, byte[] jarg2, byte[] jarg3,
        byte[] jarg4);
    ...
    public final static native int crypto_generichash_blake2b(byte[] jarg1, int jarg2, byte[] jarg3,
        int jarg4, byte[] jarg5, int jarg6);

    public final static native int crypto_generichash_blake2b_salt_personal(byte[] jarg1, int jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, int jarg6, byte[] jarg7, byte[] jarg8);

    public final static native int crypto_generichash_blake2b_init(byte[] jarg1, byte[] jarg2,
        int jarg3, int jarg4);

    public final static native int crypto_generichash_blake2b_init_salt_personal(byte[] jarg1,
        byte[] jarg2, int jarg3, int jarg4, byte[] jarg5, byte[] jarg6);

    public final static native int crypto_generichash_blake2b_update(byte[] jarg1, byte[] jarg2,
        int jarg3);

    public final static native int crypto_generichash_blake2b_final(byte[] jarg1, byte[] jarg2,
        int jarg3);
    ...
    public final static native int crypto_onetimeauth_poly1305(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4);

    public final static native int crypto_onetimeauth_poly1305_verify(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4);
    ...
    public final static native int crypto_onetimeauth_poly1305_update(byte[] jarg1, byte[] jarg2,
        int jarg3);
    ...
    public final static native int crypto_pwhash_scryptsalsa208sha256(byte[] jarg1, int jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5, int jarg6, int jarg7);

    public final static native int crypto_pwhash_scryptsalsa208sha256_str(byte[] jarg1,
        byte[] jarg2, int jarg3, int jarg4, int jarg5);

    public final static native int crypto_pwhash_scryptsalsa208sha256_str_verify(byte[] jarg1,
        byte[] jarg2, int jarg3);

    public final static native int crypto_pwhash_scryptsalsa208sha256_ll(byte[] jarg1, int jarg2,
        byte[] jarg3, int jarg4, int jarg5, int jarg6, int jarg7, byte[] jarg8, int jarg9);
    ...
    public final static native int crypto_scalarmult_curve25519(byte[] jarg1, byte[] jarg2,
        byte[] jarg3);
    ...
    public final static native int crypto_secretbox_xsalsa20poly1305(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, byte[] jarg5);

    public final static native int crypto_secretbox_xsalsa20poly1305_open(byte[] jarg1,
        byte[] jarg2, int jarg3, byte[] jarg4, byte[] jarg5);
    ...
    public final static native int crypto_shorthash_siphash24(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4);
    ...
    public final static native int crypto_sign_ed25519(byte[] jarg1, int[] jarg2, byte[] jarg3,
        int jarg4, byte[] jarg5);

    public final static native int crypto_sign_ed25519_open(byte[] jarg1, int[] jarg2, byte[] jarg3,
        int jarg4, byte[] jarg5);

    public final static native int crypto_stream_xsalsa20(byte[] jarg1, int jarg2, byte[] jarg3,
        byte[] jarg4);

    public final static native int crypto_sign_ed25519_detached(byte[] jarg1, int[] jarg2,
        byte[] jarg3, int jarg4, byte[] jarg5);

    public final static native int crypto_sign_ed25519_verify_detached(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4);

    public final static native int crypto_sign_ed25519_keypair(byte[] jarg1, byte[] jarg2);

    public final static native int crypto_sign_ed25519_seed_keypair(byte[] jarg1, byte[] jarg2,
        byte[] jarg3);
    ...
    public final static native int crypto_stream_chacha20(byte[] jarg1, int jarg2, byte[] jarg3,
        byte[] jarg4);

    public final static native int crypto_stream_chacha20_xor(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);

    public final static native int crypto_stream_chacha20_xor_ic(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, int jarg5, byte[] jarg6);

    public final static native int crypto_stream_chacha20_ietf_noncebytes();

    public final static native int crypto_stream_chacha20_ietf(byte[] jarg1, int jarg2,
        byte[] jarg3, byte[] jarg4);

    public final static native int crypto_stream_chacha20_ietf_xor(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, byte[] jarg5);

    public final static native int crypto_stream_chacha20_ietf_xor_ic(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, int jarg5, byte[] jarg6);
    ...
    public final static native int crypto_stream_salsa20(byte[] jarg1, int jarg2, byte[] jarg3,
        byte[] jarg4);

    public final static native int crypto_stream_salsa20_xor(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);

    public final static native int crypto_stream_salsa20_xor_ic(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, int jarg5, byte[] jarg6);
    ...
    public final static native int crypto_stream_xsalsa20_xor(byte[] jarg1, byte[] jarg2, int jarg3,
        byte[] jarg4, byte[] jarg5);

    public final static native int crypto_stream_xsalsa20_xor_ic(byte[] jarg1, byte[] jarg2,
        int jarg3, byte[] jarg4, int jarg5, byte[] jarg6);

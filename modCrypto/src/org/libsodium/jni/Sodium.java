...
public class Sodium {
    ...
    public static int crypto_secretbox_easy(byte[] dst_cipher, byte[] src_plain, int plain_len,
        byte[] nonce, byte[] secret_key) {
        return SodiumJNI.crypto_secretbox_easy(dst_cipher, src_plain, plain_len, nonce, secret_key);
    }

    public static int crypto_secretbox_open_easy(byte[] dst_plain, byte[] src_cipher,
        int cipher_len, byte[] nonce, byte[] secret_key) {
        return SodiumJNI
            .crypto_secretbox_open_easy(dst_plain, src_cipher, cipher_len, nonce, secret_key);
    }

    public static int crypto_secretbox_detached(byte[] dst_cipher, byte[] mac, byte[] src_plain,
        int plain_len, byte[] nonce, byte[] secretkey) {
        return SodiumJNI
            .crypto_secretbox_detached(dst_cipher, mac, src_plain, plain_len, nonce, secretkey);
    }

    public static int crypto_secretbox_open_detached(byte[] dst_plain, byte[] src_cipher,
        byte[] mac, int cipher_len, byte[] nonce, byte[] secretkey) {
        return SodiumJNI
            .crypto_secretbox_open_detached(dst_plain, src_cipher, mac, cipher_len, nonce,
                secretkey);
    }
    ...
    public static int crypto_box_seed_keypair(byte[] dst_public_key, byte[] dst_private_key,
        byte[] src_seed) {
        return SodiumJNI.crypto_box_seed_keypair(dst_public_key, dst_private_key, src_seed);
    }

    public static int crypto_box_easy(byte[] dst_cipher, byte[] src_plain, int plain_len,
        byte[] nonce, byte[] remote_public_key, byte[] local_private_key) {
        return SodiumJNI.crypto_box_easy(dst_cipher, src_plain, plain_len, nonce, remote_public_key,
            local_private_key);
    }

    public static int crypto_box_open_easy(byte[] dst_plain, byte[] src_cipher, int cipher_len,
        byte[] nonce, byte[] remote_public_key, byte[] local_private_key) {
        return SodiumJNI
            .crypto_box_open_easy(dst_plain, src_cipher, cipher_len, nonce, remote_public_key,
                local_private_key);
    }

    public static int crypto_box_detached(byte[] dst_cipher, byte[] dst_mac, byte[] src_plain,
        int plain_len, byte[] nonces, byte[] remote_public_key, byte[] local_private_key) {
        return SodiumJNI.crypto_box_detached(dst_cipher, dst_mac, src_plain, plain_len, nonces,
            remote_public_key, local_private_key);
    }

    public static int crypto_box_open_detached(byte[] dst_plain, byte[] src_cipher, byte[] src_mac,
        int cipher_len, byte[] nonce, byte[] remote_public_key, byte[] local_private_key) {
        return SodiumJNI.crypto_box_open_detached(dst_plain, src_cipher, src_mac, cipher_len, nonce,
            remote_public_key, local_private_key);
    }
    ...
    public static int crypto_box_beforenm(byte[] dst_shared_key, byte[] remote_public_key,
        byte[] local_private_key) {
        return SodiumJNI.crypto_box_beforenm(dst_shared_key, remote_public_key, local_private_key);
    }

    public static int crypto_box_easy_afternm(byte[] dst_cipher, byte[] src_plain, int plain_len,
        byte[] nonce, byte[] shared_key) {
        return SodiumJNI
            .crypto_box_easy_afternm(dst_cipher, src_plain, plain_len, nonce, shared_key);
    }

    public static int crypto_box_open_easy_afternm(byte[] dst_plain, byte[] src_cipher,
        int cipher_len, byte[] nonce, byte[] shared_key) {
        return SodiumJNI
            .crypto_box_open_easy_afternm(dst_plain, src_cipher, cipher_len, nonce, shared_key);
    }

    public static int crypto_box_detached_afternm(byte[] dst_cipher, byte[] dst_mac,
        byte[] src_plain, int plain_len, byte[] nonce, byte[] shared_key) {
        return SodiumJNI
            .crypto_box_detached_afternm(dst_cipher, dst_mac, src_plain, plain_len, nonce,
                shared_key);
    }

    public static int crypto_box_open_detached_afternm(byte[] dst_plain, byte[] src_cipher,
        byte[] src_mac, int cipher_len, byte[] nonce, byte[] shared_key) {
        return SodiumJNI
            .crypto_box_open_detached_afternm(dst_plain, src_cipher, src_mac, cipher_len, nonce,
                shared_key);
    }
    ...
    public static int crypto_box_seal(byte[] dst_cipher, byte[] src_plain, int plain_len,
        byte[] remote_public_key) {
        return SodiumJNI.crypto_box_seal(dst_cipher, src_plain, plain_len, remote_public_key);
    }

    public static int crypto_box_seal_open(byte[] dst_plain, byte[] src_cipher, int cipher_len,
        byte[] local_public_key, byte[] local_private_key) {
        return SodiumJNI.crypto_box_seal_open(dst_plain, src_cipher, cipher_len, local_public_key,
            local_private_key);
    }
    ...
    public static int crypto_box(byte[] dst_cipher, byte[] src_msg, int msg_len, byte[] src_nonce,
        byte[] src_pub, byte[] src_secret) {
        return SodiumJNI.crypto_box(dst_cipher, src_msg, msg_len, src_nonce, src_pub, src_secret);
    }

    public static int crypto_box_open(byte[] dst_msg, byte[] src_cipher, int cipher_len,
        byte[] src_nonce, byte[] src_pub, byte[] src_secret) {
        return SodiumJNI
            .crypto_box_open(dst_msg, src_cipher, cipher_len, src_nonce, src_pub, src_secret);
    }

    public static int crypto_box_afternm(byte[] dst_cipher, byte[] src_msg, int msg_len,
        byte[] src_nonce, byte[] src_key) {
        return SodiumJNI.crypto_box_afternm(dst_cipher, src_msg, msg_len, src_nonce, src_key);
    }

    public static int crypto_box_open_afternm(byte[] dst_msg, byte[] src_cipher, int cipher_len,
        byte[] src_nonce, byte[] src_key) {
        return SodiumJNI
            .crypto_box_open_afternm(dst_msg, src_cipher, cipher_len, src_nonce, src_key);
    }
    ...
    public static int crypto_sign_seed_keypair(byte[] dst_public_Key, byte[] dst_private_key,
        byte[] src_seed) {
        return SodiumJNI.crypto_sign_seed_keypair(dst_public_Key, dst_private_key, src_seed);
    }

    public static int crypto_sign(byte[] dst_signed_msg, int[] signed_msg_len, byte[] src_msg,
        int msg_len, byte[] local_private_key) {
        return SodiumJNI
            .crypto_sign(dst_signed_msg, signed_msg_len, src_msg, msg_len, local_private_key);
    }

    public static int crypto_sign_open(byte[] dst_msg, int[] msg_len, byte[] src_signed_msg,
        int signed_msg_len, byte[] remote_public_key) {
        return SodiumJNI
            .crypto_sign_open(dst_msg, msg_len, src_signed_msg, signed_msg_len, remote_public_key);
    }

    public static int crypto_sign_detached(byte[] dst_signature, int[] signature_len,
        byte[] src_msg, int msg_len, byte[] local_private_key) {
        return SodiumJNI.crypto_sign_detached(dst_signature, signature_len, src_msg, msg_len,
            local_private_key);
    }

    public static int crypto_sign_verify_detached(byte[] src_signature, byte[] src_msg, int msg_len,
        byte[] remote_public_key) {
        return SodiumJNI
            .crypto_sign_verify_detached(src_signature, src_msg, msg_len, remote_public_key);
    }
    ...
    public static int crypto_generichash(byte[] dst_hash, int dst_len, byte[] src_input,
        int input_len, byte[] src_key, int key_len) {
        return SodiumJNI
            .crypto_generichash(dst_hash, dst_len, src_input, input_len, src_key, key_len);
    }
    ...
    public static int crypto_generichash_init(byte[] state, byte[] src_key, int key_len,
        int out_len) {
    ...
    public static int crypto_shorthash(byte[] dst_out, byte[] src_input, int input_len,
        byte[] src_key) {
    ...
    public static int crypto_auth_verify(byte[] src_mac, byte[] src_input, int input_len,
        byte[] src_key) {
    ...
    public static int crypto_onetimeauth(byte[] dst_out, byte[] src_input, int input_len,
        byte[] src_key) {
        return SodiumJNI.crypto_onetimeauth(dst_out, src_input, input_len, src_key);
    }

    public static int crypto_onetimeauth_verify(byte[] src_mac, byte[] src_input, int input_len,
        byte[] src_key) {
    ...
    public static int crypto_aead_chacha20poly1305_encrypt(byte[] c, int[] clen_p, byte[] m,
        int mlen, byte[] ad, int adlen, byte[] nsec, byte[] npub, byte[] k) {
        return SodiumJNI
            .crypto_aead_chacha20poly1305_encrypt(c, clen_p, m, mlen, ad, adlen, nsec, npub, k);
    }

    public static int crypto_aead_chacha20poly1305_decrypt(byte[] m, int[] mlen_p, byte[] nsec,
        byte[] c, int clen, byte[] ad, int adlen, byte[] npub, byte[] k) {
        return SodiumJNI
    ...
    public static int crypto_aead_chacha20poly1305_ietf_encrypt(byte[] c, int[] clen_p, byte[] m,
        int mlen, byte[] ad, int adlen, byte[] nsec, byte[] npub, byte[] k) {
        return SodiumJNI
            .crypto_aead_chacha20poly1305_ietf_encrypt(c, clen_p, m, mlen, ad, adlen, nsec, npub,
                k);
    }

    public static int crypto_aead_chacha20poly1305_ietf_decrypt(byte[] m, int[] mlen_p, byte[] nsec,
        byte[] c, int clen, byte[] ad, int adlen, byte[] npub, byte[] k) {
        return SodiumJNI
            .crypto_aead_chacha20poly1305_ietf_decrypt(m, mlen_p, nsec, c, clen, ad, adlen, npub,
                k);
    }
    ...
    public static int crypto_box_curve25519xsalsa20poly1305(byte[] c, byte[] m, int mlen, byte[] n,
        byte[] pk, byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xsalsa20poly1305(c, m, mlen, n, pk, sk);
    }

    public static int crypto_box_curve25519xsalsa20poly1305_open(byte[] m, byte[] c, int clen,
        byte[] n, byte[] pk, byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xsalsa20poly1305_open(m, c, clen, n, pk, sk);
    }

    public static int crypto_box_curve25519xsalsa20poly1305_seed_keypair(byte[] pk, byte[] sk,
        byte[] seed) {
    ...
    public static int crypto_box_curve25519xsalsa20poly1305_beforenm(byte[] k, byte[] pk,
        byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xsalsa20poly1305_beforenm(k, pk, sk);
    }

    public static int crypto_box_curve25519xsalsa20poly1305_afternm(byte[] c, byte[] m, int mlen,
        byte[] n, byte[] k) {
        return SodiumJNI.crypto_box_curve25519xsalsa20poly1305_afternm(c, m, mlen, n, k);
    }

    public static int crypto_box_curve25519xsalsa20poly1305_open_afternm(byte[] m, byte[] c,
        int clen, byte[] n, byte[] k) {
    ...
    public static int crypto_generichash_blake2b(byte[] out, int outlen, byte[] in, int inlen,
        byte[] key, int keylen) {
        return SodiumJNI.crypto_generichash_blake2b(out, outlen, in, inlen, key, keylen);
    }

    public static int crypto_generichash_blake2b_salt_personal(byte[] out, int outlen, byte[] in,
        int inlen, byte[] key, int keylen, byte[] salt, byte[] personal) {
        return SodiumJNI
            .crypto_generichash_blake2b_salt_personal(out, outlen, in, inlen, key, keylen, salt,
                personal);
    }

    public static int crypto_generichash_blake2b_init(byte[] state, byte[] key, int keylen,
        int outlen) {
        return SodiumJNI.crypto_generichash_blake2b_init(state, key, keylen, outlen);
    }

    public static int crypto_generichash_blake2b_init_salt_personal(byte[] state, byte[] key,
        int keylen, int outlen, byte[] salt, byte[] personal) {
        return SodiumJNI
            .crypto_generichash_blake2b_init_salt_personal(state, key, keylen, outlen, salt,
                personal);
    }
    ...
    public static int crypto_pwhash_scryptsalsa208sha256(byte[] out, int outlen, byte[] passwd,
        int passwdlen, byte[] salt, int opslimit, int memlimit) {
        return SodiumJNI
            .crypto_pwhash_scryptsalsa208sha256(out, outlen, passwd, passwdlen, salt, opslimit,
                memlimit);
    }

    public static int crypto_pwhash_scryptsalsa208sha256_str(byte[] out, byte[] passwd,
        int passwdlen, int opslimit, int memlimit) {
        return SodiumJNI
            .crypto_pwhash_scryptsalsa208sha256_str(out, passwd, passwdlen, opslimit, memlimit);
    }

    public static int crypto_pwhash_scryptsalsa208sha256_str_verify(byte[] str, byte[] passwd,
        int passwdlen) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256_str_verify(str, passwd, passwdlen);
    }

    public static int crypto_pwhash_scryptsalsa208sha256_ll(byte[] passwd, int passwdlen,
        byte[] salt, int saltlen, int N, int r, int p, byte[] buf, int buflen) {
        return SodiumJNI
            .crypto_pwhash_scryptsalsa208sha256_ll(passwd, passwdlen, salt, saltlen, N, r, p, buf,
                buflen);
    }
    ...
    public static int crypto_secretbox_xsalsa20poly1305(byte[] c, byte[] m, int mlen, byte[] n,
        byte[] k) {
        return SodiumJNI.crypto_secretbox_xsalsa20poly1305(c, m, mlen, n, k);
    }

    public static int crypto_secretbox_xsalsa20poly1305_open(byte[] m, byte[] c, int clen, byte[] n,
        byte[] k) {
    ...
    public static int crypto_sign_ed25519_open(byte[] m, int[] mlen_p, byte[] sm, int smlen,
        byte[] pk) {
    ...
    public static int crypto_sign_ed25519_detached(byte[] sig, int[] siglen_p, byte[] m, int mlen,
        byte[] sk) {
        return SodiumJNI.crypto_sign_ed25519_detached(sig, siglen_p, m, mlen, sk);
    }

    public static int crypto_sign_ed25519_verify_detached(byte[] sig, byte[] m, int mlen,
        byte[] pk) {
    ...
    public static int crypto_sign_ed25519_pk_to_curve25519(byte[] curve25519_pk,
        byte[] ed25519_pk) {
        return SodiumJNI.crypto_sign_ed25519_pk_to_curve25519(curve25519_pk, ed25519_pk);
    }

    public static int crypto_sign_ed25519_sk_to_curve25519(byte[] curve25519_sk,
        byte[] ed25519_sk) {
    ...
    public static int crypto_stream_chacha20_xor_ic(byte[] c, byte[] m, int mlen, byte[] n, int ic,
        byte[] k) {
    ...
    public static int crypto_stream_chacha20_ietf_xor(byte[] c, byte[] m, int mlen, byte[] n,
        byte[] k) {
        return SodiumJNI.crypto_stream_chacha20_ietf_xor(c, m, mlen, n, k);
    }

    public static int crypto_stream_chacha20_ietf_xor_ic(byte[] c, byte[] m, int mlen, byte[] n,
        int ic, byte[] k) {
    ...
    public static int crypto_stream_salsa20_xor_ic(byte[] c, byte[] m, int mlen, byte[] n, int ic,
        byte[] k) {
    ...
    public static int crypto_stream_xsalsa20_xor_ic(byte[] c, byte[] m, int mlen, byte[] n, int ic,
        byte[] k) {

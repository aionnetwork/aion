 ...
 * <p>
 * It's recommended to use {@link #h256(byte[])}, {@link #h256(byte[], byte[])} and {@link
...
public class HashUtil {
    ...
    /**
     * Computes the SHA-256, a member of the SHA-2 cryptographic hash functions, of the given
     * input.
     *
     ...
     * <p>
     * NOTE: This method does NOT follow the NIST SHA3-256 standard, it's only an alias of the

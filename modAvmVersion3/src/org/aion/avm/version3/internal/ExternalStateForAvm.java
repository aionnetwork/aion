...
public final class ExternalStateForAvm implements IExternalState, IAvmExternalState {
    ...
    public boolean isValidEnergyLimitForCreate(long energyLimit) {
        return (this.isLocalCall) || this.energyRules.isValidEnergyLimit(IEnergyRules.TransactionType.CREATE, energyLimit);
    }

    @Override
    public boolean isValidEnergyLimitForNonCreate(long energyLimit) {
        return (this.isLocalCall) || this.energyRules.isValidEnergyLimit(IEnergyRules.TransactionType.NON_CREATE, energyLimit);
    }

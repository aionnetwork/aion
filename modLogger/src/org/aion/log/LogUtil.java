...
public class LogUtil {
    /**
     * Protected for now, until we can figure out why it crashes kernel, then we
     * will integrate. See : <a href=
    ...
    /**
     * Guarantees a return of at max, first 8 characters, even if data is ill
     * formatted (null, shorter, longer) etc.
     * 
     * @param data
     * @return
     */
    ...
    /**
     * Guarantees a return of at max, last 8 characters, even if data is ill
     * formatted (null, shorter, longer) etc.
     * 
     * @param data
     * @return

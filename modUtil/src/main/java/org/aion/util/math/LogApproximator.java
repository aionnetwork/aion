...
public class LogApproximator {
    ...
    private static FixedPoint log2 = new FixedPoint(new BigDecimal("0.693147180559945309"));
    ...
    static {
        ...
        for (int i = 0 ; i <= 30; i++) {
            BigDecimal value = new BigDecimal(hardCodedLogs[i]);
            logTable.add(new FixedPoint(value));
        }
    }

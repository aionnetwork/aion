...
STAKER_ADDRESS="0xa0a0fe4ff90c04e915ed244b48e338792328202fabffded06920f6d47c38041f"
   PRIVATE_KEY="0x9e8882805c5858e1328b4fc79aab4b7a115ba0b998ce88955472804101559897"
...
receipt=`./rpc.sh --call "$PRIVATE_KEY" "0" "$EXPECTED_DAPP_ADDRESS" "$callPayload" "23250000000000000000000000" "$NODE_ADDRESS"`
echo "$receipt"
require_success $?

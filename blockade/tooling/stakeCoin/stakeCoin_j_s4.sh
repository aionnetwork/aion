...
STAKER_ADDRESS="0xa003755b6829b86da1c48383e00c814b3a02f31eebe16fc1067005eb9faa411e"
   PRIVATE_KEY="0xb0778638e4da726d01db9b6714bbb09afa26bd883d997ea926afa1aa0146c0e6"
...
receipt=`./rpc.sh --call "$PRIVATE_KEY" "0" "$EXPECTED_DAPP_ADDRESS" "$callPayload" "17670000000000000000000000" "$NODE_ADDRESS"`
echo "$receipt"
require_success $?

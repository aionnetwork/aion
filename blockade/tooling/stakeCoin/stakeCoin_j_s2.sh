...
STAKER_ADDRESS="0xa02461d8b16f29730d309dcef594b9144800ec6119058924bedec1471c101716"
   PRIVATE_KEY="0xa9c3afc7747156849e0cc926a97d02366b33a3eccc47d4f671e4d52c79c57def"
...
receipt=`./rpc.sh --call "$PRIVATE_KEY" "0" "$EXPECTED_DAPP_ADDRESS" "$callPayload" "13950000000000000000000000" "$NODE_ADDRESS"`
echo "$receipt"
require_success $?

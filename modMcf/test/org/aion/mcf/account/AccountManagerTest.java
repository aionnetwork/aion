...
public class AccountManagerTest {
    ...
    private Address notRegistered = Address
    ...
    public void testUnlockAccount() {
        // unlock 2 accounts
        assertTrue(
            accountManager.unlockAccount(Address.wrap(k1.getAddress()), p1, DEFAULT_TEST_TIMEOUT));
        long timeOutTotal1 = Instant.now().getEpochSecond() + DEFAULT_TEST_TIMEOUT;
        assertTrue(
            accountManager.unlockAccount(Address.wrap(k2.getAddress()), p2, DEFAULT_TEST_TIMEOUT));
    ...
    public void testUnlockAccountWithWrongPassword() {
        assertFalse(accountManager
            .unlockAccount(Address.wrap(k1.getAddress()), "not p1", DEFAULT_TEST_TIMEOUT));
    ...
    public void testUnlockAccountTimeoutGreaterThanMax() {
        ...
        assertTrue(accountManager
            .unlockAccount(Address.wrap(k1.getAddress()), p1, AccountManager.UNLOCK_MAX + 10));
    ...
    public void testLockAccountWithWrongPassword() {
        // first unlock an account
        assertTrue(accountManager
            .unlockAccount(Address.wrap(k1.getAddress()), p1, DEFAULT_TEST_TIMEOUT + 1));
    ...
    public void testUnlockAndLockMultipleTimes() {
        // first an account
        assertTrue(accountManager
            .unlockAccount(Address.wrap(k1.getAddress()), p1, AccountManager.UNLOCK_DEFAULT));
        assertThat(accountManager.getAccounts().size()).isEqualTo(1);

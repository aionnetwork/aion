 ...
 *
 * Represents the <code>launcher</code> subsection within the </code><code>gui</code> section of
 * Aion kernel config.
 */
...
//                keepKernelOnExit == that.keepKernelOnExit &&
    ...
    public int hashCode() {
        return Objects
            .hashCode(autodetectJavaRuntime, javaHome, aionSh, workingDir, /*keepKernelOnExit,*/
                kernelPidFile);
    }
}

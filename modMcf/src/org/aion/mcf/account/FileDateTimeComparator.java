...
/**
 * Used to compare the formatted date on keystore files to determine the
 * progenitor (original/coinbase) key. Note that if the key is not valid, a
 * series of (abitrary) choices are made for the ordering of the invalid file
 * name.
 * <p>
 * <p>
 ...
 * </ul>
 * <p>
 * The class will silently fail if and guarantees (hopefully) to not throw any
 * errors
 *
 * @author yao
 */

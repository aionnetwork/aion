...
public class AccountState extends AbstractState {
     ...
     * <p>
     * In the case of contract accounts the number of contract-creations made by this account.
     *
     ...
     * <p>
     * This is the code that gets executed should this address receive a message call.
     *
     ...
     * <p>
     * All the code fragments are contained in the state database under their corresponding hashes
     * for later retrieval.
     *
     ...
     * from the current one. If the method is called with the already existing balance, the object
     * state will not be set to dirty.
     */
    ...
    public boolean isEmpty() {
        return FastByteComparisons.equal(codeHash, EMPTY_DATA_HASH) && BigInteger.ZERO
            .equals(balance)

...
public class MasterKeyTest {
    ...
    private static final byte[] EXPECTED_CHAIN_M_0H_PRIVATE =
            HEX.decode("1559eb2bbec5790b0c65d8693e4d0875b1747f4970ae8b650486ed7470845635");
    private static final byte[] EXPECTED_CHAIN_M_0H_PUBLIC =
            HEX.decode("86fab68dcb57aa196c77c5f264f215a112c22a912c10d123b0d03c3c28ef1037");
    private static final byte[] EXPECTED_CHAIN_M_0H_2147483647H_PRIVATE =
            HEX.decode("ea4f5bfe8694d8bb74b7b59404632fd5968b774ed545e810de9c32a4fb4192f4");
    private static final byte[] EXPECTED_CHAIN_M_0H_2147483647H_PUBLIC =
            HEX.decode("5ba3b9ac6e90e83effcd25ac4e58a1365a9e35a3d3ae5eb07b9e4d90bcf7506d");
    private static final byte[] EXPECTED_CHAIN_M_0H_2147483647H_1H_PRIVATE =
            HEX.decode("3757c7577170179c7868353ada796c839135b3d30554bbb74a4b1e4a5a58505c");
    private static final byte[] EXPECTED_CHAIN_M_0H_2147483647H_1H_PUBLIC =
            HEX.decode("2e66aa57069c86cc18249aecf5cb5a9cebbfd6fadeab056254763874a9352b45");
    ...
    public void testDeriveHardened() throws Exception {
        ECKey hashedKey =
                CryptoUtils.getECKey(CryptoUtils.hashSha512(CryptoUtils.ED25519_KEY, SEED));
        MasterKey unit = new MasterKey(hashedKey);

        ECKey chain_m_0H = unit.deriveHardened(new int[] {0});
        byte[] chain_m_0H_left = Arrays.copyOfRange(chain_m_0H.getPrivKeyBytes(), 0, 32);
        ...
        byte[] chain_m_0H_2147483647H_left =
                Arrays.copyOfRange(chain_m_0H_2147483647H.getPrivKeyBytes(), 0, 32);
        ...
        byte[] chain_m_0H_2147483647H_1H_left =
                Arrays.copyOfRange(chain_m_0H_2147483647H_1H.getPrivKeyBytes(), 0, 32);

        assertThat(chain_m_0H_2147483647H_1H_left, is(EXPECTED_CHAIN_M_0H_2147483647H_1H_PRIVATE));
        assertThat(
                chain_m_0H_2147483647H_1H.getPubKey(),
        ...
        byte[] chain_m_0H_2147483647H_1H_2147483646H_left =
                Arrays.copyOfRange(chain_m_0H_2147483647H_1H_2147483646H.getPrivKeyBytes(), 0, 32);

        assertThat(
                chain_m_0H_2147483647H_1H_2147483646H_left,
                is(EXPECTED_CHAIN_M_0H_2147483647H_1H_2147483646H_PRIVATE));
        assertThat(
                chain_m_0H_2147483647H_1H_2147483646H.getPubKey(),
        ...
        byte[] chain_m_0H_2147483647H_1H_2147483646H_2H_left =
                Arrays.copyOfRange(
                        chain_m_0H_2147483647H_1H_2147483646H_2H.getPrivKeyBytes(), 0, 32);

        assertThat(
                chain_m_0H_2147483647H_1H_2147483646H_2H_left,
                is(EXPECTED_CHAIN_M_0H_2147483647H_1H_2147483646H_2H_PRIVATE));
        assertThat(
                chain_m_0H_2147483647H_1H_2147483646H_2H.getPubKey(),

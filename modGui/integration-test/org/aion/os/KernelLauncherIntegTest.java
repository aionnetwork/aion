...
public class KernelLauncherIntegTest {
    ...
    public void test() throws Exception {
        ...
        System.out.println(
                "Before kernel launch, PIDs for Aion kernel process: " + aionPidsInitial);
        ...
        // test will not work properly if there's two instances of it running simultaneously from
        // the same user
        Thread.sleep(3000); // pause because new process doesn't immediately show up in pgrep
        List<Long> aionPidsAfterLaunch = pgrep("Aion$");
        System.out.println(
                "After kernel launch, PIDs for Aion kernel process: " + aionPidsAfterLaunch);
        ...
        // terminate the kernel instance using a different launcher (simulates exit GUI / reopen GUI
        // case)
        ...
        // after receiving TERM signal, process does some clean-up before exiting, so check
        // periodically
        ...
        do {
            ...
            System.out.println(
                    "After kernel launch, PIDs for Aion kernel process: " + aionPidsAfterTerm);
                    ...
                    .flatMap(
                            pid -> {
                                try {
                                    ...
                                    System.out.println(
                                            String.format(
                                                    "Ignored unparseable line from pgrep: '%s'",
                                                    pid));
                                    return Stream.empty();
                                }
                            })

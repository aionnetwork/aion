...
public class SendControllerIntegTest extends ApplicationTest {
    ...
    public void testKernelConnectedWithMasterUnlockedThenBalanceChanged() {
        ...
        when(balanceRetriever.getBalance(account.getPublicAddress())).thenReturn(new BigInteger("1337"));
        new DataUpdater().run();

        WaitForAsyncUtils.waitForFxEvents();
        verifyThat("#accountBalance", TextInputControlMatchers.hasText("0.000000000000001337 AION"));
    }
    ...
    public void testKernelGenerateTransaction() throws Exception {
        ...
        clickOn("#toInput").write("0xa0c0ffee11111111111111111111111111111111111111111111111111111111");
        ...
        ArgumentCaptor<SendTransactionDTO> sendTxDtoCapture = ArgumentCaptor.forClass(SendTransactionDTO.class);
        ...
        assertThat(sendTxDto.getTo(), is("0xa0c0ffee11111111111111111111111111111111111111111111111111111111"));

 ...
 *
 * Test focuses on the correctness of the UI elements.  Classes from the model layer are mocked and
 * we verify that they get called, but their correctness is not verified here (those are taken care
 * of in the integration and unit tests of the model layer).
 */

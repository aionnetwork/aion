...
public class UnixProcessTerminator {
     ...
     *
     * Specifically, send SIGTERM to that process, then poll the UNIX ps program to verify that the
     * process has stopped.  Keep checking until it has either stopped or the "timeout until

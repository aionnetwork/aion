...
public final class CryptoUtils {
     ...
     * SLIP-0010.  I is calculated by computing a 512-bit byte sequence for given mnemonic
     * according to BIP-0039, then hashing that sequence with HMAC-SHA512.
     *
     ...
     */
    public static ECKey generateSha512HashedBip39ECKey(final String mnemonic) throws ValidationException {
     ...
     * @throws ValidationException
     */
    public static byte[] hashSha512(final byte[] secret, final byte[] hashData) throws ValidationException {
        final byte[] bytes;
        try {

...
public class MasterKey {
    ...
    private byte[] getChild(final int pathElement, final byte[] keyHash)
        ...
        byte[] parentPaddedKey =
                org.spongycastle.util.Arrays.concatenate(new byte[] {0}, parentPrivateKey, offset);

...
public class AccountCellItem extends ListCell<AccountDTO> {
    ...
    @FXML private TextField importedLabel;
    @FXML private HBox nameBox;
    @FXML private TextField name;
    @FXML private TextField publicAddress;
    @FXML private TextField balance;
    @FXML private ImageView accountSelectButton;
    @FXML private ImageView editNameButton;
    @FXML private ImageView accountExportButton;

    private boolean nameInEditMode;

    private static final String ICON_CONNECTED =
            "/org/aion/wallet/ui/components/icons/icon-connected-50.png";
    private static final String ICON_DISCONNECTED =
            "/org/aion/wallet/ui/components/icons/icon-disconnected-50.png";
    private static final String ICON_EDIT =
            "/org/aion/wallet/ui/components/icons/pencil-edit-button.png";
    private static final String ICON_CONFIRM =
            "/org/aion/wallet/ui/components/icons/icons8-checkmark-50.png";

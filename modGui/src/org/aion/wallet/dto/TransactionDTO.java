...
public class TransactionDTO implements Comparable<TransactionDTO> {
    ...
    public TransactionDTO(final String from, final String to, final String hash,
        final BigInteger value, final long nrg, final long nrgPrice, final long timeStamp,

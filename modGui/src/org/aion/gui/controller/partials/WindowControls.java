...
public class WindowControls {
    ...
    private final WindowControlsEvent closeEvent = new WindowControlsEvent(
        WindowControlsEvent.Type.CLOSE, null);
    ...
    private void minimize(final MouseEvent mouseEvent) {
        ...
        final WindowControlsEvent minimizeEvent = new WindowControlsEvent(
            WindowControlsEvent.Type.MINIMIZE, source);

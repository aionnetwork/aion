...
public class EventExecuteServiceTest {
    ...
    public void testTakeWithMockito() {
        EventExecuteService ees =
                new EventExecuteService(100, "test", Thread.NORM_PRIORITY, LOGGER_EVENT);
    ...
    public void testQueueFull() {
        EventExecuteService ees =
                new EventExecuteService(100, "test", Thread.NORM_PRIORITY, LOGGER_EVENT);
        for (int i = 0; i < 101; i++) ees.add(new EventDummy());
        // queue full
    ...
    public void testThreadNameNull() {
        EventExecuteService ees =
                new EventExecuteService(100, null, Thread.NORM_PRIORITY, LOGGER_EVENT);
    }
    ...
    public void testInvalidQSize() {
        EventExecuteService ees =
                new EventExecuteService(10, "test", Thread.NORM_PRIORITY, LOGGER_EVENT);
    }

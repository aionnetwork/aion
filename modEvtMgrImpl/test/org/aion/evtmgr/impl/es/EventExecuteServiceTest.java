...
public class EventExecuteServiceTest {
    ...
    public void testTakeWithMockito() {
        EventExecuteService ees = new EventExecuteService(100, "test", Thread.NORM_PRIORITY,
            LOGGER_EVENT);
    ...
    public void testThreadNameNull() {
        EventExecuteService ees = new EventExecuteService(100, null, Thread.NORM_PRIORITY,
            LOGGER_EVENT);
    }
    ...
    public void testInvalidQSize() {
        EventExecuteService ees = new EventExecuteService(10, "test", Thread.NORM_PRIORITY,
            LOGGER_EVENT);
    }

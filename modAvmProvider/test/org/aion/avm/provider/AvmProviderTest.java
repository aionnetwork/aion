...
public class AvmProviderTest {
    ...
    private void addBalance(RepositoryCache<AccountState, IBlockStoreBase> repository, AionAddress account, BigInteger amount) {
    ...
    private RepositoryCache<AccountState, IBlockStoreBase> newRepository() {
    ...
    private IAvmExternalState newExternalState(AvmVersion version, RepositoryCache<AccountState, IBlockStoreBase> repository, IEnergyRules energyRules) {

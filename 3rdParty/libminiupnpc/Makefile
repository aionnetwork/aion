...
# the jna only work at java8 or above, make sure the java path is correct before you compile the upnp lib
JAVA = java
...
JNAERATORARGS = -mode StandaloneJar -runtime JNAerator -library miniupnpc -noLibBundle -preferJavac

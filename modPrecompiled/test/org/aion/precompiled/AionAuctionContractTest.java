...
public class AionAuctionContractTest {
    ...
    private Address domainAddress1 = Address
        .wrap("a011111111111111111111111111111101010101010101010101010101010101");
    ...
    private static AionBlock createBundleAndCheck(StandaloneBlockchain bc, ECKey key,
    ...
    public void newTest() {
        ...
        byte[] combined = setupInputs("12312421412.41dsfsdgsdg.aion",
            Address.wrap(defaultKey.getAddress()), amount.toByteArray(), defaultKey);
    ...
    public void testWithANS() {
        ...
        BigInteger amount = new BigInteger("1000");
        byte[] combined = setupInputs(domainName2, Address.wrap(k.getAddress()),
            amount.toByteArray(), k);
        AionAuctionContract aac = new AionAuctionContract(repo, AION, blockchain);
        ExecutionResult result = aac.execute(combined, inputEnergy);

        BigInteger amount4 = new BigInteger("6000");
        byte[] combined4 = setupInputs(domainName2, Address.wrap(k4.getAddress()),
            amount4.toByteArray(), k4);
        ...
        byte[] combined2 = setupInputs(domainName2, Address.wrap(k2.getAddress()),
            amount2.toByteArray(), k2);
        ...
        byte[] combined3 = setupInputs(domainName2, Address.wrap(k3.getAddress()),
            amount3.toByteArray(), k3);
        ...
        assertEquals(5000,
            repo.getBalance(Address.wrap(k4.getAddress())).intValue()); // deposits 5000
    ...
    public void testCheckBidBalances() {
        final long inputEnergy = 24000L;
        BigInteger amount = new BigInteger("1000");
        byte[] combined = setupInputs(domainName1, Address.wrap(k.getAddress()),
            amount.toByteArray(), k);
        AionAuctionContract aac = new AionAuctionContract(repo, AION, blockchain);
        aac.execute(combined, inputEnergy);

        BigInteger amount2 = new BigInteger("3000");
        byte[] combined2 = setupInputs(domainName1, Address.wrap(k2.getAddress()),
            amount2.toByteArray(), k2);
        AionAuctionContract aac2 = new AionAuctionContract(repo, AION, blockchain);
        aac2.execute(combined2, inputEnergy);

        BigInteger amount3 = new BigInteger("2000");
        byte[] combined3 = setupInputs(domainName1, Address.wrap(k3.getAddress()),
            amount3.toByteArray(), k3);
        AionAuctionContract aac3 = new AionAuctionContract(repo, AION, blockchain);
        aac3.execute(combined3, inputEnergy);

        BigInteger amount4 = new BigInteger("5000");
        byte[] combined4 = setupInputs(domainName1, Address.wrap(k4.getAddress()),
            amount4.toByteArray(), k4);
        AionAuctionContract aac4 = new AionAuctionContract(repo, AION, blockchain);
        aac4.execute(combined4, inputEnergy);
        ...
        byte[] combined6 = setupInputs(domainName2, Address.wrap(k.getAddress()),
            amount6.toByteArray(), k);
        ...
        byte[] combined7 = setupInputs(domainName2, Address.wrap(k2.getAddress()),
            amount7.toByteArray(), k2);
    ...
    public void testQuery() {
        ...
        byte[] combined = setupInputs("aion.aion", Address.wrap(k.getAddress()),
            amount.toByteArray(), k);
        AionAuctionContract aac = new AionAuctionContract(repo, AION, blockchain);
        aac.execute(combined, DEFAULT_INPUT_NRG);

        byte[] combined2 = setupInputs("aaaa.aion", Address.wrap(k.getAddress()),
            amount2.toByteArray(), k);
        AionAuctionContract aac2 = new AionAuctionContract(repo, AION, blockchain);
        aac.execute(combined2, DEFAULT_INPUT_NRG);

        byte[] combined3 = setupInputs("bbbb.aaaa.aion", Address.wrap(k2.getAddress()),
            amount3.toByteArray(), k2);
        AionAuctionContract aac3 = new AionAuctionContract(repo, AION, blockchain);
        aac.execute(combined3, DEFAULT_INPUT_NRG);

        byte[] combined8 = setupInputs("aion.aion", Address.wrap(k.getAddress()),
            amount2.toByteArray(), k);
        ...
        aac.execute(setupInputs("111.aion", Address.wrap(k.getAddress()), amount.toByteArray(), k),
            DEFAULT_INPUT_NRG);
        aac.execute(setupInputs("222.aion", Address.wrap(k.getAddress()), amount.toByteArray(), k),
            DEFAULT_INPUT_NRG);
        aac.execute(setupInputs("333.aion", Address.wrap(k.getAddress()), amount.toByteArray(), k),
            DEFAULT_INPUT_NRG);
        aac.execute(setupInputs("444.aion", Address.wrap(k.getAddress()), amount.toByteArray(), k),
            DEFAULT_INPUT_NRG);
        aac.execute(setupInputs("555.aion", Address.wrap(k.getAddress()), amount.toByteArray(), k),
            DEFAULT_INPUT_NRG);
        aac.execute(setupInputs("666.aion", Address.wrap(k.getAddress()), amount.toByteArray(), k),
            DEFAULT_INPUT_NRG);
        ...
        byte[] combined4 = setupInputs("cccc.aaaa.aion", Address.wrap(k.getAddress()),
            amount3.toByteArray(), k);
        AionAuctionContract aac4 = new AionAuctionContract(repo, AION, blockchain);
        aac.execute(combined4, DEFAULT_INPUT_NRG);

        byte[] combined6 = setupInputs("cccc.aaaa.aion", Address.wrap(k2.getAddress()),
            amount.toByteArray(), k2);
        AionAuctionContract aac6 = new AionAuctionContract(repo, AION, blockchain);
        aac.execute(combined6, DEFAULT_INPUT_NRG);

        byte[] combined7 = setupInputs("cccc.aaaa.aion", Address.wrap(k2.getAddress()),
            amount4.toByteArray(), k2);
        AionAuctionContract aac7 = new AionAuctionContract(repo, AION, blockchain);
    ...
    public void testHasActiveParentDomain() {
        ...
        byte[] combined = setupInputs("parent.aion", Address.wrap(k.getAddress()),
            amount.toByteArray(), k);
        AionAuctionContract aac = new AionAuctionContract(repo, AION, blockchain);
        aac.execute(combined, inputEnergy);
        ...
        byte[] combined2 = setupInputs("child.parent.aion", Address.wrap(k.getAddress()),
            amount.toByteArray(), k);
        AionAuctionContract aac2 = new AionAuctionContract(repo, AION, blockchain);
    ...
    public void testInvalidDomainNames() {
        byte[] combined = setupInputs("aa.aion", Address.wrap(defaultKey.getAddress()),
            defaultBidAmount.toByteArray(), defaultKey);
        AionAuctionContract aac = new AionAuctionContract(repo, AION, blockchain);
        ExecutionResult result = aac.execute(combined, DEFAULT_INPUT_NRG);
        assertEquals(ResultCode.INTERNAL_ERROR, result.getResultCode());

        byte[] combined2 = setupInputs("#$%aion.aion", Address.wrap(defaultKey.getAddress()),
            defaultBidAmount.toByteArray(), defaultKey);
        AionAuctionContract aac2 = new AionAuctionContract(repo, AION, blockchain);
        ExecutionResult result2 = aac2.execute(combined2, DEFAULT_INPUT_NRG);
        assertEquals(ResultCode.INTERNAL_ERROR, result2.getResultCode());

        byte[] combined3 = setupInputs("withoutdotaion", Address.wrap(defaultKey.getAddress()),
            defaultBidAmount.toByteArray(), defaultKey);
        AionAuctionContract aac3 = new AionAuctionContract(repo, AION, blockchain);
        ...
        byte[] combined4 = setupInputs("ai.ai.ai.ai.aion", Address.wrap(defaultKey.getAddress()),
            defaultBidAmount.toByteArray(), defaultKey);
        AionAuctionContract aac4 = new AionAuctionContract(repo, AION, blockchain);
        ...
        byte[] combined5 = setupInputs("network.aion", Address.wrap(defaultKey.getAddress()),
            defaultBidAmount.toByteArray(), defaultKey);
    ...
    public void testBidderAddressDoesNotExist() {
        ...
        byte[] combined = setupInputs("bion.bion.aion", Address.wrap(notExistKey.getAddress()),
            defaultBidAmount.toByteArray(), notExistKey);
        AionAuctionContract aac = new AionAuctionContract(repo, AION, blockchain);
        ExecutionResult result = aac.execute(combined, DEFAULT_INPUT_NRG);
        assertEquals(ResultCode.INTERNAL_ERROR, result.getResultCode());
    ...
    public void testInsufficientBalance() {
        ...
        byte[] combined3 = setupInputs(domainName1, Address.wrap(poorKey.getAddress()),
            defaultBidAmount.toByteArray(), poorKey);
    ...
    public void testIncorrectInputLength() {
        byte[] input = setupInputs(domainName1, Address.wrap(defaultKey.getAddress()),
            defaultBidAmount.toByteArray(), defaultKey);
    ...
    public void testIncorrectPublicKey() {
        ...
        byte[] input = setupInputs(domainName1, Address.wrap(defaultKey.getAddress()),
            defaultBidAmount.toByteArray(), anotherKey);
        ExecutionResult result = testAAC.execute(input, DEFAULT_INPUT_NRG);
    ...
    public void testNegativeBidValue() {
        ...
        byte[] input = setupInputs(domainName1, Address.wrap(defaultKey.getAddress()),
            negativeBidAmount.toByteArray(), defaultKey);
        ExecutionResult result = testAAC.execute(input, DEFAULT_INPUT_NRG);
    ...
    public void testRequestedDomainIsAlreadyActive() {
        ...
        AionAuctionContract aac2 = new AionAuctionContract(repo, AION, blockchain);
        byte[] input2 = setupInputs(domainName1, Address.wrap(k2.getAddress()),
            bidAmount2.toByteArray(), k2);
        ...
        Assert.assertArrayEquals("requested domain is already active".getBytes(),
            result2.getOutput());
    }
    ...
    public void testOverwritingBidsWithSmallerValue() {
        ...
        byte[] input2 = setupInputs(domainName1, Address.wrap(defaultKey.getAddress()),
            newBidAmount.toByteArray(), defaultKey);
        ExecutionResult result2 = testAAC.execute(input2, DEFAULT_INPUT_NRG);

        BigInteger anotherBid = new BigInteger("10");
        byte[] input3 = setupInputs(domainName1, Address.wrap(k2.getAddress()),
            anotherBid.toByteArray(), k2);
    ...
    public void testRequestInactiveDomain() {
        ...
        byte[] input3 = setupInputs(domainName1, Address.wrap(k3.getAddress()),
            anotherAmount.toByteArray(), k3);

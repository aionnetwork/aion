...
public class TokenBridgeContract extends StatefulPrecompiledContract implements Transferable {
    ...
    public TokenBridgeContract(@Nonnull final ExecutionContext context,
        ...
        this.controller = new BridgeController(this.connector, this.context.helper(),
        ...
        switch (sig) {
            case SIG_CHANGE_OWNER: {
                ...
                ErrCode code = this.controller
                    .setNewOwner(this.context.sender().toBytes(), address);
            ...
            case SIG_RING_INITIALIZE: {
                ...
                ErrCode code = this.controller
                    .ringInitialize(this.context.sender().toBytes(), addressList);
                if (code != ErrCode.NO_ERROR) {
                    return fail();
                }
                return success();
            ...
            case SIG_RING_ADD_MEMBER: {
                ...
                ErrCode code = this.controller
                    .ringAddMember(this.context.sender().toBytes(), address);
                if (code != ErrCode.NO_ERROR) {
                    return fail();
                }
                return success();
            ...
            case SIG_RING_REMOVE_MEMBER: {
                ...
                ErrCode code = this.controller
                    .ringRemoveMember(this.context.sender().toBytes(), address);
                if (code != ErrCode.NO_ERROR) {
                    return fail();
                }
                return success();
     ...
     */
    private AionInternalTx newInternalTx(Address from, Address to, BigInteger nonce, DataWord value,
        byte[] data,
        String note) {

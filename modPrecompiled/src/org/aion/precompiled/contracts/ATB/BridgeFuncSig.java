...
enum BridgeFuncSig {
    ...
    SIG_RING_INITIALIZE     ("initializeRing(getRecipient[])"),
    SIG_RING_ADD_MEMBER     ("addRingMember(getRecipient)"),
    SIG_RING_REMOVE_MEMBER  ("removeRingMember(getRecipient)"),
    SIG_SET_RELAYER         ("setRelayer(getRecipient)"),
    SIG_SUBMIT_BUNDLE       ("submitBundle(bytes32,getRecipient[],uint128[],bytes32[],bytes32[],bytes32)"),
    PURE_OWNER              ("owner()"),

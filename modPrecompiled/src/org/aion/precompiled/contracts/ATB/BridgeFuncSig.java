...
enum BridgeFuncSig {
     ...
     * @return {@code enum} representing the function signature to be switched upon, if the input is
     * considered malformed, or the signature is missing this function will return {@code null}
     */
